...
class UserSteam(models.Model):
    user = models.OneToOneField(settings.AUTH_USER_MODEL, related_name='steam', on_delete=models.CASCADE)
    player = models.OneToOneField(Player, related_name='steam', on_delete=models.CASCADE)
